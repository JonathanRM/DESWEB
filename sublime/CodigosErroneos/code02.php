<?php
	...
	function avatarCode($entrada)
	{
		...
		/*
		En la funcion PHP he modificado el return (return $valor_salida++;) que lo que hacia era mostrar el valor de salida y después incrementarlo a +1, de tal forma que no mostraba como queriamos el resultado.

Como ha quedado para que salga correctamente:
 return ++$valor_salida; 

Incrementará en +1 a $valor_salida y mostrará el resultado.
